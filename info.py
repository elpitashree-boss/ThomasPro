...
# Multiple ForceSub channel ids support
auth_channels = environ.get('AUTH_CHANNEL', '-1002523899081 -1002440888043 -1002197586423')
AUTH_CHANNEL = [int(ch) for ch in auth_channels.split() if id_pattern.search(ch)]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Interworld_Backup')
