...
API_ID = int(environ.get('API_ID', '28212220'))
API_HASH = environ.get('API_HASH', '854f483d871a6fbab3c2f5449c7f7515')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/iim.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6330347502 8130146718').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002670519258'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002447165404').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002054253243') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002901354720')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://elpitashree_db_user:LJsjuwJae2vwBw1L@cluster0.fezxixq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TheInterworldGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Dear_Batman')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'interworld_bots') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/EL_Pita_Shree')
